...
- Supply-demand imbalance affects revenue
 ...
 ![ride_stutus](surge_vs_ride_status.png)
...
## 📈 Outcome
Improved understanding of ride failures and actionable business solutions.

## 📂 Files in Repository
- `zoomride_case_study.ipynb` → Python analysis
